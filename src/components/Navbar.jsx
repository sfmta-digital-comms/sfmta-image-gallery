...
const Navbar = () => {
  ...
  const navbarStyle = {
    ...
    color: '#fff',
    display: 'flex', // Ensure navbar contents align properly
    alignItems: 'center', // Vertically center the contents
    justifyContent: 'start', // Align contents to the start of the navbar
    height: '50px', // Match the height of the children
